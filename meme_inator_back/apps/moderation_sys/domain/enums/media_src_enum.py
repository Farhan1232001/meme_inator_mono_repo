...
class MediaSourceEnum(str, Enum):
    """
    Conveys WHERE content, usually the BLOB, is stored within application/controller layer.
    ...
    """
    REQUEST_BODY = "request_body"      # content provided inline in the request
