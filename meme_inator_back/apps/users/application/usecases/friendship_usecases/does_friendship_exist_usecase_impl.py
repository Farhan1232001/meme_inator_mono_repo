...
from apps.users.domain.usecases.friendship_usecases.idoes_friendship_exist_usecase import IDoesFriendshipExistUsecase

class DoesFriendshipExistUsecaseImpl(IDoesFriendshipExistUsecase):
