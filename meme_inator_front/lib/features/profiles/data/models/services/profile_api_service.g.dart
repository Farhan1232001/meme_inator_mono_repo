...
class _ProfileApiService implements ProfileApiService {
  ...
  Future<ProfileResponseDto> getPublicProfileWithFollowshipContext(
    ...
    final _options = _setStreamType<ProfileResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/profiles/profile/${username}/with_followship_context',
  ...
  Future<ProfileResponseDto> getPublicProfile(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'viewerUserId': viewerUserId};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProfileResponseDto>(
  ...
  @override
  Future<ProfileResponseDto> createProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ProfileResponseDto> updateCounters(CountersUpdateDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ProfileResponseDto> syncMedia(MediaSyncDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<Map<String, String>> getProfileImageUrls() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
